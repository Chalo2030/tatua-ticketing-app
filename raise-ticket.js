// Load existing submissions from sessionStorage or initialize an empty array
let formSubmissions = JSON.parse(sessionStorage.getItem("formSubmissions")) || [];
...
function storeFormData(fullName, email, phone, message, subject, fileName) {
    ...
    sessionStorage.setItem("formSubmissions", JSON.stringify(formSubmissions)); 
...
function loadTickets() {
    const storedTickets = sessionStorage.getItem("formSubmissions");
    return storedTickets ? JSON.parse(storedTickets) : [];
}

// Save tickets to sessionStorage
function saveTickets(tickets) {
    sessionStorage.setItem("formSubmissions", JSON.stringify(tickets));
}
